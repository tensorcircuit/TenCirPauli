...
- Phase 7.5 native performance slice: move Majorana-to-fermion expansion, parity/Bravyi–Kitaev mapping plans and transforms, and ChargeSector suffix-count DP/rank/unrank/basis generation into Rust behind coarse PyO3 calls; retain Python input validation, contribution-table construction, compact result shaping, and an arbitrary-integer Python fallback. Add independent mixed-layout differential coverage and release small/medium/large A/B benchmarks.
