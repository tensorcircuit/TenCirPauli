...
- [Phase 7.5 implementation and performance review, 2026-08-03](phase-7.5-review-2026-08-03.md): open remediation report covering exact-integer charge correctness, direct Majorana mapping, packed representation, memory preflight, parity/BK execution, restricted-compiler scaling, and the required closure tests and benchmarks.
